...
\begin{equation}
  \delta\Delta_\mathrm{HFS}^\mathrm{Mills} = -0.216 \pm 0.001~\mathrm{MHz}\,\text{(numerical)}.
...
\begin{tabular}{lcccccc}
 & $\Delta_\mathrm{HFS}$ & Residual & $\delta_B$ & Combined (est.) & Final residual & Significance \\
 & (MHz) & (MHz) & (MHz) & (MHz) & (MHz) & \\
\hline
